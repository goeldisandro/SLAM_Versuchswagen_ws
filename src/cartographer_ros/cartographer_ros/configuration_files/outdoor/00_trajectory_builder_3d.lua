...
-- Festlegen ob ein Scan eingefügt wird oder nicht
  motion_filter = {
    max_time_seconds = 4, -- nach 5 sec wird immer eingefügt
    max_distance_meters = 2,  -- wenn zum letzten Scan ein gewisser Abstand festgestellt wird
    max_angle_radians =  math.rad(2.), -- wenn zum letzten Scan eine gewisse Rotation festgestellt wird
  },
...
-- Einstellungen zum Erstellen der Submaps
  submaps = {
    high_resolution = 0.25,		-- festlegen der Auflösung der beiden Probability-Grids
