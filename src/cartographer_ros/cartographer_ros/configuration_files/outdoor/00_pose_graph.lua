POSE_GRAPH = {
  optimize_every_n_nodes = 5,		-- set to 0 for testing local slam (global slam is run every n nodes)
  
-- Sucht nach Constraints
  constraint_builder = {
    fast_correlative_scan_matcher = {	-- 2D Sucht passensde Maps (Submaps - Nodes) -> Constraint
      linear_search_window = 40.,	-- je kleiner desto schneller
    ...
    sampling_ratio = 0.1, --A constraint will be added if the proportion of added constraints to potential constraints dropsbelow this number
    max_constraint_distance = 30., --max Abstand von einem Node zu einer Submap
...
-- optimiert den Pose Graph anhand aller constraints
  ...
  global_sampling_ratio = 0.6, -- Rate at which we sample a single trajectory’s nodes for global localization.
