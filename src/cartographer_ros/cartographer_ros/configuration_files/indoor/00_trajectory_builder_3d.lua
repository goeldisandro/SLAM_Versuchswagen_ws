...
TRAJECTORY_BUILDER_3D = {
  ...
  num_accumulated_range_data = 100, 	-- wieviele Einzelne PointCloud2 Messages zusammen fürs scan-matching verwendet werden (sollte 360° abdecken)
  ...
  high_resolution_adaptive_voxel_filter = { -- adaptiver Filter
    max_length = 0.1, -- maximale grösse der Voxels
...
-- Einstellungen zum Erstellen der Submaps
  submaps = {
    high_resolution = 0.05,		-- festlegen der Auflösung der beiden Probability-Grids
    high_resolution_max_range = 20., -- max Dinstanz des hochaufgelösten Probability-Grids
    low_resolution = 0.5,		--
    num_range_data = 80,		-- Grösse der Submap, so wählen, dass sie in sich konsistent ist
